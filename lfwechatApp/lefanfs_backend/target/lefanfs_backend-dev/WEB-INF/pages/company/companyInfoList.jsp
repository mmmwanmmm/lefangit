...
<div class="main administrator">
    ...
    <div class="panel panel-info">
            ...
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/company/companyInfoList" method="post">
                    ...
                    <div class="btn-group">
                       ...
                       &nbsp; &nbsp; &nbsp; &nbsp; <button onclick="addinfo()" type="button" class="btn btn-default">添加公司服务信息</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${companyInfoDtoList}" var="item">
                <tr>
                    <td></td>
                    <td>${item.title}</td>
            ...
            <tr>
                <td colspan="10">
                    <c:if test="${page > 1}">
                        <a href="${ctx}/company/companyInfoList?page=${page-1}">上一页</a>&nbsp;
                    </c:if>
                    <a href="${ctx}/company/companyInfoList?page=${page+1}">下一页</a>
                </td>
            </tr>
            </tbody>
        </table>
