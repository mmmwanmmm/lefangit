...
<html>
<head>
    <title>乐凡金服运营管理后台</title>
    <%@ include file="/WEB-INF/pages/common/css.jsp" %>
</head>
<body class="easyui-layout" onload="javascript:addTab('用户列表','${ctx}/user/userList','update');" href="javascript:;" title="用户管理">

<div region="north" class="head">
    <span><img height="25px" width="25px" src="${ctx}/img/logo.png"/>乐凡金服运营管理后台</span>
    <div class="user">
...
<script type="text/javascript">
    ...
    /*function init() {
        ...
        window.location = "${ctx}/user/userList";
    }*/
